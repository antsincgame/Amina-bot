...
const REALTIME_PATTERNS = [
  ...
  /лучши[еёх]|худши[еёх]|топ[\s-]?\d|рейтинг|обзор|сравни|сравнени/i,
  /сам[ыо][ейх]\s+\w+|самая\s+\w+|самое\s+\w+/i,     // "самые красивые", "самый большой"
  /\d+\s*(?:лучших|красив|популярн|интересн|дорог|дешёв|опасн|безопасн)/i, // "10 красивых", "5 лучших"
  ...
  // "какой/какая/какие" + контекст (без контекста слишком жадный)
  /как(?:ой|ая|ие|ов)\s+(?:сейчас|сегодня|был|была|будет|текущ|нынешн|актуальн)/i,
  /как(?:ой|ая|ие)\s+(?:курс|цена|погода|счёт|результат|рейтинг|версия)/i,
  // "почему/зачем" только с контекстом событий
  /почему\s+(?:упал|вырос|подорожал|подешевел|закрыл|отменил|запретил|разрешил)/i,
